...
-- CreateIndex
CREATE UNIQUE INDEX "Share_userId_artworkId_key" ON "Share"("userId", "artworkId");
...
-- AddForeignKey
ALTER TABLE "Share" ADD CONSTRAINT "Share_artworkId_fkey" FOREIGN KEY ("artworkId") REFERENCES "Artwork"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
